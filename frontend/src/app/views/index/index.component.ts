    ...
    /* 
     ...
     <div class="row">
                            <div class="col" style="text-align: center;">
                                <button class="btn btn-primary boton" id="btn-modal" type="button">
                                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-bag-plus" style="font-size: 15px;">
                                    ...
                                    </svg>&nbsp;Añadir a la cesta</button></div>
                        </div>
